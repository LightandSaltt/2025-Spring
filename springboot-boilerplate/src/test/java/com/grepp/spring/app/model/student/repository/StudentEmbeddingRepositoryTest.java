...
class StudentEmbeddingRepositoryTest {
    ...
    public void save(){
        ...
        student.setMbti(MBTI.ENTJ);
        student.setMajor("backend");

        studentEmbeddingRepository.save(StudentEmbedding.fromEntity(student, model));
        assertThat(studentEmbeddingRepository.existsById("test")).isTrue();
    }

    @Test
    public void findByMbti(){
        studentEmbeddingRepository.findByMbti(MBTI.ENTJ)
    ...
    public void update(){
        ...
        embedding.embed(model); // gemini 를 위해 다시 임비드 해줘야 함

        studentEmbeddingRepository.save(embedding); // 정보 저장
    ...
    public void delete(){
        ...
        assertThat(studentEmbeddingRepository.existsById("test")).isFalse();
    }
}