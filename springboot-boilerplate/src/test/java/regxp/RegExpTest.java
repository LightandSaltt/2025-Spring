...
public class RegExpTest {
    ...
    void testFlag(){
        ...
        Matcher m2 = Pattern.compile("(?mi)^ja", Pattern.MULTILINE | Pattern.CASE_INSENSITIVE).matcher(str);
    ...
    void pracRegExp1(){
        ...
        String reg = "^[0-9][0-9][01][09][0123][0-9]-[1-4][0-9][0-9][0-9][0-9][0-9][0-9]$";
        Pattern pattern = Pattern.compile(reg);
        assertTrue(pattern.matcher("001022-1222222").matches());
        assertFalse(pattern.matcher("001022-8222222").matches());
    }
    ...
    void testGroup(){
        ...
        // | : or
        // 숫자 6자리 - 숫자 7자리
        // 주민등록 3번째 자리에는 0,1만 올 수 있다.
        // 3번째 자리에 1이 올 경우 4번째 자리는 0,1,2만 올 수 있다

        // 주민등록번호의 다섯번째 자리에는 0~3 사이의 숫자만 올 수 있다.
        // 다섯번째 자리에 3이 올 경우 6번째 자리의 숫자는 0,1만 올수 있다.
...
//        assertFalse(pattern.matcher("001022-8222222").matches());
    ...
    void testPasswordValidation(){
        // 숫자, 영문자, 특수문자가 1개 이상 포함된 8자리 이상의 문자열
